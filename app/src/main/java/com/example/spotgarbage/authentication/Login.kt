...
fun login(navController: NavController) {
    ...
    Column(
        ...
        Column(
            ...
            OutlinedTextField(
                value = passowrdTextState.value, onValueChange = { passowrdTextState.value = it },
            ...
            Button(
                onClick = {
                    if (emailTextState.value.isEmpty() || passowrdTextState.value.isEmpty()) {
                        ...
                        loginUser(emailTextState.value, passowrdTextState.value) { result ->
                ...
                modifier = Modifier.fillMaxWidth().padding(start = 50.dp, end = 50.dp, top = 25.dp)
                    .height(50.dp),
